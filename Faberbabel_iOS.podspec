...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of Faberbabel_iOS.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jean Haberer/Faberbabel_iOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jean Haberer' => 'jean.haberer@fabernovel.com' }
  s.source           = { :git => 'https://github.com/Jean Haberer/Faberbabel_iOS.git', :tag => s.version.to_s }
